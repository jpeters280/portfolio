	...
	$.fn.skillset = function( options ) {
		...
		function create_trigger(element){
			...
			for(var i = 0; i < count; i++){
				...
				var html = '<li class="displayOnHover skill-'+(i+1)+'""><p>'+settings.object[i]['headline']+' <span class="icon-info-circled" >'+settings.object[i]['description']+'</span></p><div class="bar"></div></li>';
